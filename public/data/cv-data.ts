...
export const experiences: Experiences = {
	aiven: {
		...
		from: 'November 2022',
		to: 'Today',
		title: 'Software engineer at Aiven',
		company: [
			'Aiven is a global open-source data platform that simplifies data infrastructure by providing cloud data management tools.',
			'The Aiven Platform offers a comprehensive suite of services, including popular open-source options for streaming, storing, and analyzing data, along with management tools for unified visibility and control across cloud data projects, facilitating easy integration, scaling, and deployment on major public cloud platforms',
		],
		link: 'https://aiven.io/',
		team: [
			'At Aiven, our team is a lively blend of members with different seniorities, featuring full-stack and frontend developers with a strong emphasis on frontend skills. We collaborate daily on exciting projects, mainly focusing on improving the Aiven design system "@aivenio/aquarium" and building intricate user interfaces.',
		],
		list: [
			"Continuous improvement of the Aiven platform's UI by refining and expanding the Aiven component library.",
			'Developing intricate features using React, TypeScript, and React Testing Library, aligning with Figma designs to enhance the overall user experience.',
			'Contributing to the technical architecture of frontend systems, optimizing performance, and ensuring scalability for evolving project requirements.',
			'Collaborating with cross-functional teams to integrate frontend functionality seamlessly with the backend.',
			'Conducting code reviews and providing constructive feedback to teammates, fostering a culture of code quality and knowledge sharing.',
			'Leading initiatives to enhance developer experience by improving frontend tooling, automation, and documentation.',
		],
		/* reflection: [
      '',
    ] */
	...
	autentek_1: {
		...
		link: 'https://autentek.de',
		header: [
			'In March 2016 I achieved my degree with a final grade of 1.2, and one year ahead of schedule.',
		],
		list: [
