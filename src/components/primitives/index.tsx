...
export const btn_small =
	'uppercase rounded-md px-2 py-1 h-6 w-full md:max-w-[8rem] text-xs';
...
export const pill =
	'bg-gl text-black dark:bg-neutral-700 dark:text-white rounded-full px-3 py-1';
...
export const HR: FC<ReactProps> = ({className = '', style}) => (
	<hr
		className={classNames('border-t-2 w-full', blackBorder, className)}
